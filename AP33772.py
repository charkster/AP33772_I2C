...
#        self.i2c.writeto_mem(self.slave_id, address, data.to_bytes(num_bytes, "little"))
    self.i2c.write_i2c_block_data(self.slave_id, address, list(data.to_bytes(num_bytes,"little")))
...
#        int_read_byte = int.from_bytes(self.i2c.readfrom_mem(self.slave_id, address, num_bytes), "little")
        int_read_byte = int.from_bytes(bytearray(self.i2c.read_i2c_block_data(self.slave_id, address, num_bytes)), "little")
